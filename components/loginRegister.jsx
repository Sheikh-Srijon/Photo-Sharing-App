                    ...
                    <Button
                        ...
                        onClick={(e) => {
                            ...
                            axios.post('/admin/login', { login_name: loginName, password: password }).then(response => {
                                ...
                                //access user._id
                                // console.log('login  res test ',response.data._id);
                                let id=  response.data._id;
                                console.log('loginreg this.props ', props);

                                props.isLoggedIn.setState({ loggedIn: true , userId: id});

                                
                                // <Redirect path='/loginRegister' to ={url}/>
