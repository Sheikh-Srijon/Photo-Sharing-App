...
const { InsertDriveFileRounded } = require('@material-ui/icons');
/*
...
// var {userSchema, userModel} = require('./user');//// added 
...
var photoSchema = new mongoose.Schema({
    ...
    numLikes: Number, //number of likes per photo
    user_liked:[mongoose.Schema.Types.ObjectId],////added
    hide_from: [mongoose.Schema.Types.ObjectId]//hide photos from these users 
